hotel_info = {
    ...
    "policies": {
        ...
        "breakfast": "Breakfast is €22 per person (not included in room rate). Served daily 8:00-10:00 AM on the terrace with lake views. Rich buffet with fresh pastries, bread, local Slovenian products. Vegan, vegetarian, and gluten-free options available on request.",
    ...
    "dining": {
        "breakfast": {
            "description": "€22 per person (not included in room rate). Served daily 8:00-10:00 AM on the terrace with lake views.",
